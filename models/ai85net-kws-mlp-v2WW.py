...
class AI85KWS20MLPV2(nn.Module):
    """
    ...
    def __init__(self,
        ...
        self.d1 = ai8x.FusedLinearReLU(num_channels, 128, bias=bias, **kwargs)
        self.d2 = ai8x.FusedLinearReLU(128, 64, bias=bias, **kwargs)
        self.d3 = ai8x.FusedLinearReLU(64, 32, bias=bias, **kwargs)
        self.d4 = ai8x.FusedLinearReLU(32, 64, bias=bias, **kwargs)
        self.d5 = ai8x.FusedLinearReLU(64, 128, bias=bias, **kwargs)
        self.d6 = ai8x.FusedLinearReLU(128, fc_inputs, bias=bias, **kwargs)
...
def ai85kws20mlpv2(pretrained=False, **kwargs):
    """
    Construct a AI85KWSMLP model.
    rn AI85KWS20MLP(**kwargs)
    """
    assert not pretrained
    return AI85KWS20MLPV2(**kwargs)
